...
int main(){
  int numbers[2], // Array dengan tipe integer dengan size 3 digunakan menyimpan nilai yang akan dibandingkan.
  ...
  {
    if (numbers[i] > besar) { // kondisi ketika numbers[i] lebih besar atau sama dengan dari variabel.
      besar = numbers[i]; // jika true maka ganti nilai variabel besar dengan nilai variabel array index ke i.
    } else { // jika nilai numbers ke i tidak besar atau sama dengan maka lakukan else.
